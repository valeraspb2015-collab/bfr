...
const faqData = [
  {
    ...
    answer: "БФР — это альтернативный путь к аренде жилья: технологический помощник, который возвращает прямой контакт между гостями и хозяевами, сохраняя удобство онлайн-сервисов, но без лишних посреднических комиссий и задержек выплат. Платформа опирается на силу сообществ и нейросетей, чтобы автоматизировать рутину и дать людям возможность договариваться напрямую. БФР не является стороной сделки — ответственность и договорённости остаются за участниками. Мы заинтересованы в успешном бронировании и прозрачных отношениях."
  },
  {
    question: "Чем БФР отличается от онлайн-площадок бронирования?",
