      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            ...
            <p className="text-sm leading-relaxed mb-6 flex-1" style={{ color: "#6b6560" }}>
              Получайте подходящие заявки от гостей напрямую в мессенджер.
              Никаких комиссий платформе — только прямой контакт с вашим будущим гостем.
            </p>
            <ul className="space-y-2 mb-6">
              {[
                "Заявки приходят прямо в ваш мессенджер",
                "Сами выбираете, кому отвечать",
                "Профессиональное сообщество хозяев",
              ].map((item) => (
                <li key={item} className="flex items-start gap-2 text-sm" style={{ color: "#6b6560" }}>
