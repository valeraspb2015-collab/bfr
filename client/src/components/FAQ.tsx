...
const faqData = [
  {
    ...
    answer: "Персональный подбор квартиры без долгого поиска и звонков по объявлениям. Запрос обрабатывается оператором или ассистентом, гости получают до 5 актуальных предложений, которые максимально соответствуют их пожеланиям."
  },
  {
